        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              LegendItem(
                icon: Icons.block,
                description: 'Es zeigt an, dass es auf dem Weg möglicherweise Hindernisse gibt, die für Menschen mit Behinderungen eine Herausforderung darstellen könnten.',
              ),
              ...
              LegendItem(
                icon: Icons.stairs,
                description: 'Es zeigt an, dass der Weg Stufen oder Treppen enthält und daher möglicherweise für Menschen mit eingeschränkter Mobilität schwierig ist.',
              ),
              SizedBox(height: 40),
              LegendItem(
                icon: Icons.elevator,
                description: 'Es zeigt an, dass der Weg eine Rampe für Rollstuhlfahrer oder Personen mit Gehhilfen aufweist und somit leichter zugänglich ist.',
              ),
            ],
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Expanded(child: Text(description, softWrap: true,)),
      ],
    );
  }
}
